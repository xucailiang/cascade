...
# Cascade导入
from cascade.types import AudioChunk, AudioConfig, VADConfig, VADResult
...
class VADTimestampAccuracyTest:
    ...
    def __init__(self, config: TestConfig):
        self.config = config
        self.ground_truth: GroundTruthSegment | None = None
        self.vad_results: list[VADResult] = []
        self.detected_segments: list[VADDetectionResult] = []
        self.metrics: AccuracyMetrics | None = None
