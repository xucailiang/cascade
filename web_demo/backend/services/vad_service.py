...
from cascade.types import VADConfig as CascadeVADConfig
...
class VADService:
    ...
    async def get_session(self, session_id: str) -> VADSession | None:
        """获取VAD会话"""
    ...
    async def process_file(self, file_path: str, config: dict[str, Any] | None = None) -> dict[str, Any]:
        """处理音频文件"""
