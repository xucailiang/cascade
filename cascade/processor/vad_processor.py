...
import logging
import time
from typing import AsyncIterator, Optional, Union, Iterator
...
class VADProcessorConfig(BaseModel):
    ...
    # 线程池配置
    thread_pool_config: Optional[VADThreadPoolConfig] = Field(
        default=None,
...
async def create_vad_processor(
    ...
    processor_config: Optional[VADProcessorConfig] = None
) -> VADProcessor:
    """
    创建并初始化VAD处理器
