...
from cascade.types import (
    AudioChunk, VADResult, VADConfig, AudioConfig, 
...
from cascade._internal.utils import measure_time, get_memory_usage
...
class VADThreadPool:
    ...
    def __init__(self, vad_config: VADConfig, audio_config: AudioConfig, 
                 pool_config: Optional[VADThreadPoolConfig] = None):
        """
        初始化VAD线程池
